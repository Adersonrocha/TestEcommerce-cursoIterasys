...
public class ProdutoPage {
	...
	private By preProduto = By.cssSelector(".current-price span:nth-child(1)");
	...
	public String obterPrecoProduto() {
		return driver.findElement(preProduto).getText();
	}
	...
	public ModalProdutoPage botaoAddCarrinho() {
