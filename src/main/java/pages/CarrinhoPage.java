...
public class CarrinhoPage {
	...
	// private By tamanhoProduto = By.className("");
	...
	public String toString() {
		return "CarrinhoPage [driver=" + driver + ", nomeProduto=" + nomeProduto + ", precoProduto=" + precoProduto
				+ ", tamanhoProduto=" + tamanhoProduto + ", corProduto=" + corProduto + ", input_quantidadeProduto="
				+ input_quantidadeProduto + ", subtotalProduto=" + subtotalProduto + ", numeroItensTotal="
				+ numeroItensTotal + ", shippingTotal=" + shippingTotal + ", totalTaxExclTotal=" + totalTaxExclTotal
				+ ", totalTaxIncTotal=" + totalTaxIncTotal + ", taxesTotal=" + taxesTotal + "]";
	}
